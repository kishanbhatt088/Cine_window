...
<html lang="en">
    ...
    <body>
        <div class="loginpagebox" id="cuslogin">
            ...
            <div class="imgbox">
                <img src="../customer/image/cuslogin.jpg" alt="">
...
<!----------------------------------------------------------customer registration----------------------------------------------------->
        <div class="loginpagebox" id="cusregistration">
            <div class="imgbox">
                <img src="../customer/image/cusregistration.jpg" alt="">
...
<!---------------------------------------------------------theatre login box------------------------------------------------------------>
        <div class="loginpagebox" id = "worlogin">
            <div class="imgbox" onclick="worregistration()">
                <img src="../customer/image/worlogin.jpg" alt="">
            ...
            <div class="databox">
                ...
                <form method="post" action="check.php">
                    <div class="userinput">
                        <i class="fa-solid fa-user"></i>
                        <input type="text" name="o_phone" placeholder="Phone Number">
                    </div>
                    <div class="userinput">
                        <i class="fa-solid fa-key"></i>
                        <input type="password" name="password" placeholder="Password">
...
<!----------------------------------------------theatre registration box------------------------------------------------------------------------->
        <div class="loginpagebox" id="worregistration">
            <div class="databox">
                ...
                <form method="post" action="check.php">
                    ...
                    <div class="userinput">
                        ...
                        <input type="text" name="th_name" placeholder="th_name">
                    </div>
                    <div class="userinput">
    
                        <input type="text" name="own_phone" placeholder="owner Phone Number">
                    </div>
                    <div class="userinput">
                        
                        <input type="text" name="th_address" placeholder="address">
                    </div>
                    <div class="userinput">
            ...
            <div class="imgbox">
                <img src="../customer/image/worregistration.jpg" alt="">
...
<!-------------------------------------------------------------admin login box--------------------------------------------------------------------->
        <div class="loginpagebox" id="adminlogin">
            <div class="imgbox">
                <img src="../customer/image/adminlogin.jpg" alt="">
